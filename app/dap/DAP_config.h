...
*/
static inline unsigned char DAP_GetVendorString (char *str) {
  (void)str;
  return (0U);
}
...
\return String length (including terminating NULL character) or 0 (no string).
*/
static inline unsigned char DAP_GetProductString (char *str) {
  (void)str;
  return (0U);
}
...
\return String length (including terminating NULL character) or 0 (no string).
*/
static inline unsigned char DAP_GetSerNumString (char *str) {
  (void)str;
  return (0U);
}
...
\return String length (including terminating NULL character) or 0 (no string).
*/
static inline unsigned char DAP_GetTargetDeviceVendorString (char *str) {
#if TARGET_FIXED != 0
  unsigned char len;

  strcpy(str, TargetDeviceVendor);
  len = (unsigned char)(strlen(TargetDeviceVendor) + 1U);
  return (len);
#else
  (void)str;
  return (0U);
...
\return String length (including terminating NULL character) or 0 (no string).
*/
static inline unsigned char DAP_GetTargetDeviceNameString (char *str) {
#if TARGET_FIXED != 0
  unsigned char len;

  strcpy(str, TargetDeviceName);
  len = (unsigned char)(strlen(TargetDeviceName) + 1U);
  return (len);
#else
  (void)str;
  return (0U);
...
\return String length (including terminating NULL character) or 0 (no string).
*/
static inline unsigned char DAP_GetTargetBoardVendorString (char *str) {
#if TARGET_FIXED != 0
  unsigned char len;

  strcpy(str, TargetBoardVendor);
  len = (unsigned char)(strlen(TargetBoardVendor) + 1U);
  return (len);
#else
  (void)str;
  return (0U);
...
\return String length (including terminating NULL character) or 0 (no string).
*/
static inline unsigned char DAP_GetTargetBoardNameString (char *str) {
#if TARGET_FIXED != 0
  unsigned char len;

  strcpy(str, TargetBoardName);
  len = (unsigned char)(strlen(TargetBoardName) + 1U);
  return (len);
#else
  (void)str;
  return (0U);
...
\return String length (including terminating NULL character) or 0 (no string).
*/
static inline unsigned char DAP_GetProductFirmwareVersionString (char *str) {
  (void)str;
  return (0U);
}
...
*/
static inline unsigned int PIN_TDI_IN  (void) {
  return (0U);
}
...
*/
static inline void     PIN_TDI_OUT (unsigned int bit) {
  ;
}
...
*/
static inline unsigned int PIN_TDO_IN  (void) {
  return (0U);
}
...
*/
static inline unsigned int PIN_nTRST_IN   (void) {
  return (0U);
}
...
*/
static inline void     PIN_nTRST_OUT  (unsigned int bit) {
  ;
}
...
*/
static inline unsigned int PIN_nRESET_IN  (void) {
  return (0U);
}
...
*/
static inline void     PIN_nRESET_OUT (unsigned int bit) {
  ;
}
...
*/
static inline void LED_CONNECTED_OUT (unsigned int bit) {}
...
*/
static inline void LED_RUNNING_OUT (unsigned int bit) {}
...
*/
static inline unsigned char RESET_TARGET (void) {
