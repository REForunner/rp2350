...
typedef struct {
  ...
  uint8_t     padding[2];
  unsigned int   clock_delay;                       // Clock Delay
  unsigned int     timestamp;                       // Last captured Timestamp
  struct {                                      // Transfer Configuration
    ...
    unsigned int  match_mask;                       // Match Mask
  } transfer;
#if (DAP_SWD != 0)
...
extern void     JTAG_Sequence   (unsigned int info,  const uint8_t *tdi,  uint8_t *tdo);
extern void     JTAG_IR         (unsigned int ir);
extern unsigned int JTAG_ReadIDCode (void);
extern void     JTAG_WriteAbort (unsigned int data);
extern uint8_t  JTAG_Transfer   (unsigned int request, unsigned int *data);
extern uint8_t  SWD_Transfer    (unsigned int request, unsigned int *data);

extern void     Delayms         (unsigned int delay);

extern unsigned int SWO_Transport      (const uint8_t *request, uint8_t *response);
extern unsigned int SWO_Mode           (const uint8_t *request, uint8_t *response);
extern unsigned int SWO_Baudrate       (const uint8_t *request, uint8_t *response);
extern unsigned int SWO_Control        (const uint8_t *request, uint8_t *response);
extern unsigned int SWO_Status                                 (uint8_t *response);
extern unsigned int SWO_ExtendedStatus (const uint8_t *request, uint8_t *response);
extern unsigned int SWO_Data           (const uint8_t *request, uint8_t *response);

extern void     SWO_QueueTransfer    (uint8_t *buf, unsigned int num);
extern void     SWO_AbortTransfer    (void);
extern void     SWO_TransferComplete (void);

extern unsigned int SWO_Mode_UART     (unsigned int enable);
extern unsigned int SWO_Baudrate_UART (unsigned int baudrate);
extern unsigned int SWO_Control_UART  (unsigned int active);
extern void     SWO_Capture_UART  (uint8_t *buf, unsigned int num);
extern unsigned int SWO_GetCount_UART (void);

extern unsigned int SWO_Mode_Manchester     (unsigned int enable);
extern unsigned int SWO_Baudrate_Manchester (unsigned int baudrate);
extern unsigned int SWO_Control_Manchester  (unsigned int active);
extern void     SWO_Capture_Manchester  (uint8_t *buf, unsigned int num);
extern unsigned int SWO_GetCount_Manchester (void);

extern unsigned int UART_Transport (const uint8_t *request, uint8_t *response);
extern unsigned int UART_Configure (const uint8_t *request, uint8_t *response);
extern unsigned int UART_Control   (const uint8_t *request, uint8_t *response);
extern unsigned int UART_Status                            (uint8_t *response);
extern unsigned int UART_Transfer  (const uint8_t *request, uint8_t *response);

extern uint8_t  USB_COM_PORT_Activate (unsigned int cmd);

extern unsigned int DAP_ProcessVendorCommand (const uint8_t *request, uint8_t *response);
extern unsigned int DAP_ProcessCommand       (const uint8_t *request, uint8_t *response);
extern unsigned int DAP_ExecuteCommand       (const uint8_t *request, uint8_t *response);
